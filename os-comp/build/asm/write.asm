...
/home/weihuan/Documents/testsuits-for-oskernel-preliminary/riscv-syscalls-testing/user/build/riscv64/write:     file format elf64-littleriscv
...
void test_write(){
    ...
    107e:	e6e50513          	addi	a0,a0,-402 # 1ee8 <__clone+0x40>
}
    ...
    1332:	18bc                	addi	a5,sp,120
{
    ...
    135c:	bf8b0b13          	addi	s6,s6,-1032 # 1f50 <__clone+0xa8>
    buf[i++] = '0';
...
size_t strlen(const char *s)
{
    ...
    18b2:	6aa5b583          	ld	a1,1706(a1) # 1f58 <__clone+0xb0>
    18b6:	00000617          	auipc	a2,0x0
    18ba:	6aa63603          	ld	a2,1706(a2) # 1f60 <__clone+0xb8>
    ...
    18ea:	00757713          	andi	a4,a0,7
{
    ...
    191a:	65253503          	ld	a0,1618(a0) # 1f68 <__clone+0xc0>
    ...
    192c:	6308b883          	ld	a7,1584(a7) # 1f58 <__clone+0xb0>
    1930:	00000817          	auipc	a6,0x0
    1934:	63083803          	ld	a6,1584(a6) # 1f60 <__clone+0xb8>
    1938:	431d                	li	t1,7
...
char *strcpy(char *restrict d, const char *s)
{
    ...
    19ba:	5a263603          	ld	a2,1442(a2) # 1f58 <__clone+0xb0>
    19be:	00000817          	auipc	a6,0x0
    19c2:	5a283803          	ld	a6,1442(a6) # 1f60 <__clone+0xb8>
...
char *strncpy(char *restrict d, const char *s, size_t n)
{
    ...
    1b9c:	3c08b883          	ld	a7,960(a7) # 1f58 <__clone+0xb0>
    1ba0:	00000817          	auipc	a6,0x0
    1ba4:	3c083803          	ld	a6,960(a6) # 1f60 <__clone+0xb8>
    1ba8:	431d                	li	t1,7
