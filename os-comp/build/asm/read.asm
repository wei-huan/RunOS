...
/home/weihuan/Documents/testsuits-for-oskernel-preliminary/riscv-syscalls-testing/user/build/riscv64/read:     file format elf64-littleriscv
...
void test_read() {
    ...
    1062:	ee250513          	addi	a0,a0,-286 # 1f40 <__clone+0x82>
    ...
    107a:	e8a50513          	addi	a0,a0,-374 # 1f00 <__clone+0x42>
    ...
    108e:	e9650513          	addi	a0,a0,-362 # 1f20 <__clone+0x62>
    ...
    1348:	18bc                	addi	a5,sp,120
{
    ...
    1372:	be2b0b13          	addi	s6,s6,-1054 # 1f50 <__clone+0x92>
    buf[i++] = '0';
...
size_t strlen(const char *s)
{
    ...
    18c8:	6945b583          	ld	a1,1684(a1) # 1f58 <__clone+0x9a>
    18cc:	00000617          	auipc	a2,0x0
    18d0:	69463603          	ld	a2,1684(a2) # 1f60 <__clone+0xa2>
    ...
    1900:	00757713          	andi	a4,a0,7
{
    ...
    1930:	63c53503          	ld	a0,1596(a0) # 1f68 <__clone+0xaa>
    ...
    1942:	61a8b883          	ld	a7,1562(a7) # 1f58 <__clone+0x9a>
    1946:	00000817          	auipc	a6,0x0
    194a:	61a83803          	ld	a6,1562(a6) # 1f60 <__clone+0xa2>
    194e:	431d                	li	t1,7
...
char *strcpy(char *restrict d, const char *s)
{
    ...
    19d0:	58c63603          	ld	a2,1420(a2) # 1f58 <__clone+0x9a>
    19d4:	00000817          	auipc	a6,0x0
    19d8:	58c83803          	ld	a6,1420(a6) # 1f60 <__clone+0xa2>
...
char *strncpy(char *restrict d, const char *s, size_t n)
{
    ...
    1bb2:	3aa8b883          	ld	a7,938(a7) # 1f58 <__clone+0x9a>
    1bb6:	00000817          	auipc	a6,0x0
    1bba:	3aa83803          	ld	a6,938(a6) # 1f60 <__clone+0xa2>
    1bbe:	431d                	li	t1,7
...
0000000000001d06 <times>:
    register long a7 __asm__("a7") = n;
    1d06:	09900893          	li	a7,153
    __asm_syscall("r"(a7), "0"(a0))
    1d0a:	00000073          	ecall
...
0000000000001d12 <get_time>:

int64 get_time()
{
    1d12:	1141                	addi	sp,sp,-16
    register long a7 __asm__("a7") = n;
    ...
    1d22:	ed09                	bnez	a0,1d3c <get_time+0x2a>
    {
        return ((time.sec & 0xffff) * 1000 + time.usec / 1000);
    1d24:	67a2                	ld	a5,8(sp)
    1d26:	3e800713          	li	a4,1000
    1d2a:	00015503          	lhu	a0,0(sp)
    1d2e:	02e7d7b3          	divu	a5,a5,a4
    1d32:	02e50533          	mul	a0,a0,a4
    1d36:	953e                	add	a0,a0,a5
    }
    else
    {
        return -1;
    ...
    1d3a:	8082                	ret
        return -1;
    1d3c:	557d                	li	a0,-1
    1d3e:	bfed                	j	1d38 <get_time+0x26>

0000000000001d40 <sys_get_time>:
    register long a7 __asm__("a7") = n;
...
0000000000001d4c <time>:
    register long a7 __asm__("a7") = n;
    1d4c:	42600893          	li	a7,1062
    __asm_syscall("r"(a7), "0"(a0))
    1d50:	00000073          	ecall
...
0000000000001d58 <sleep>:

int sleep(unsigned long long time)
{
    1d58:	1141                	addi	sp,sp,-16
    TimeVal tv = {.sec = time, .usec = 0};
    1d5a:	e02a                	sd	a0,0(sp)
    register long a0 __asm__("a0") = a;
    1d5c:	850a                	mv	a0,sp
    1d5e:	e402                	sd	zero,8(sp)
    register long a7 __asm__("a7") = n;
    1d60:	06500893          	li	a7,101
    register long a1 __asm__("a1") = b;
    1d64:	85aa                	mv	a1,a0
    __asm_syscall("r"(a7), "0"(a0), "r"(a1))
    1d66:	00000073          	ecall
    if (syscall(SYS_nanosleep, &tv, &tv)) return tv.sec;
    1d6a:	e501                	bnez	a0,1d72 <sleep+0x1a>
    return 0;
    1d6c:	4501                	li	a0,0
}
    ...
    1d70:	8082                	ret
    if (syscall(SYS_nanosleep, &tv, &tv)) return tv.sec;
    1d72:	4502                	lw	a0,0(sp)
}
    1d74:	0141                	addi	sp,sp,16
    1d76:	8082                	ret

0000000000001d78 <set_priority>:
    register long a7 __asm__("a7") = n;
    1d78:	08c00893          	li	a7,140
    __asm_syscall("r"(a7), "0"(a0))
    1d7c:	00000073          	ecall
...
0000000000001d8e <munmap>:
    register long a7 __asm__("a7") = n;
    1d8e:	0d700893          	li	a7,215
    __asm_syscall("r"(a7), "0"(a0), "r"(a1))
    1d92:	00000073          	ecall
...
0000000000001d9a <wait>:

int wait(int *code)
{
    1d9a:	85aa                	mv	a1,a0
    register long a7 __asm__("a7") = n;
    1d9c:	10400893          	li	a7,260
    register long a0 __asm__("a0") = a;
    1da0:	557d                	li	a0,-1
    register long a2 __asm__("a2") = c;
    1da2:	4601                	li	a2,0
