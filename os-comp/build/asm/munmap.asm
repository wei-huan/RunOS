...
/home/weihuan/Documents/testsuits-for-oskernel-preliminary/riscv-syscalls-testing/user/build/riscv64/munmap:     file format elf64-littleriscv
...
void test_munmap(void){
    ...
    100a:	f4a50513          	addi	a0,a0,-182 # 1f50 <__clone+0x2c>
void test_munmap(void){
    ...
    101c:	0b050513          	addi	a0,a0,176 # 20c8 <__func__.0>
    1020:	364000ef          	jal	ra,1384 <puts>
    1024:	00001517          	auipc	a0,0x1
    1028:	f4450513          	addi	a0,a0,-188 # 1f68 <__clone+0x44>
    ...
    1038:	f4450513          	addi	a0,a0,-188 # 1f78 <__clone+0x54>
    103c:	473000ef          	jal	ra,1cae <open>
    1040:	842a                	mv	s0,a0
    write(fd, str, strlen(str));
    1042:	00001517          	auipc	a0,0x1
    1046:	f4650513          	addi	a0,a0,-186 # 1f88 <__clone+0x64>
    104a:	0bf000ef          	jal	ra,1908 <strlen>
    104e:	862a                	mv	a2,a0
    1050:	00001597          	auipc	a1,0x1
    1054:	f3858593          	addi	a1,a1,-200 # 1f88 <__clone+0x64>
    1058:	8522                	mv	a0,s0
    105a:	493000ef          	jal	ra,1cec <write>
    fstat(fd, &kst);
    105e:	00001497          	auipc	s1,0x1
    1062:	fea48493          	addi	s1,s1,-22 # 2048 <kst>
    1066:	85a6                	mv	a1,s1
    1068:	8522                	mv	a0,s0
    106a:	5cf000ef          	jal	ra,1e38 <fstat>
    printf("file len: %d\n", kst.st_size);
    106e:	788c                	ld	a1,48(s1)
    1070:	00001517          	auipc	a0,0x1
    1074:	f3850513          	addi	a0,a0,-200 # 1fa8 <__clone+0x84>
    ...
    1084:	460d                	li	a2,3
    1086:	4501                	li	a0,0
    1088:	563000ef          	jal	ra,1dea <mmap>
    ...
    1094:	561000ef          	jal	ra,1df4 <munmap>
    1098:	84aa                	mv	s1,a0
	printf("munmap return: %d\n",ret);
    109a:	85aa                	mv	a1,a0
    109c:	00001517          	auipc	a0,0x1
    10a0:	f2c50513          	addi	a0,a0,-212 # 1fc8 <__clone+0xa4>
    ...
    10ae:	f6650513          	addi	a0,a0,-154 # 2010 <__clone+0xec>
    ...
    10c0:	f4450513          	addi	a0,a0,-188 # 2000 <__clone+0xdc>
    10c4:	2c0000ef          	jal	ra,1384 <puts>
    10c8:	00001517          	auipc	a0,0x1
    10cc:	00050513          	mv	a0,a0
    ...
    10de:	e8e50513          	addi	a0,a0,-370 # 1f68 <__clone+0x44>
}
    ...
    10ea:	efa50513          	addi	a0,a0,-262 # 1fe0 <__clone+0xbc>
    10ee:	53c000ef          	jal	ra,162a <panic>
	if (ret == 0)
    10f2:	b7d1                	j	10b6 <test_munmap+0xb2>
	printf("mmap error.\n");
    10f4:	00001517          	auipc	a0,0x1
    10f8:	ec450513          	addi	a0,a0,-316 # 1fb8 <__clone+0x94>
    ...
    112e:	f406                	sd	ra,40(sp)
{
    ...
    113c:	fa060613          	addi	a2,a2,-96 # 20d8 <digits>
    buf[16] = 0;
    ...
    1272:	e6a60613          	addi	a2,a2,-406 # 20d8 <digits>
    buf[16] = 0;
    ...
    13ae:	18bc                	addi	a5,sp,120
{
    ...
    13d8:	c54b0b13          	addi	s6,s6,-940 # 2028 <__clone+0x104>
    buf[i++] = '0';
    13dc:	830aca93          	xori	s5,s5,-2000
        buf[i++] = digits[x >> (sizeof(uint64) * 8 - 4)];
    13e0:	00001997          	auipc	s3,0x1
    13e4:	cf898993          	addi	s3,s3,-776 # 20d8 <digits>
        if (!*s)
...
size_t strlen(const char *s)
{
    ...
    192e:	7065b583          	ld	a1,1798(a1) # 2030 <__clone+0x10c>
    1932:	00000617          	auipc	a2,0x0
    1936:	70663603          	ld	a2,1798(a2) # 2038 <__clone+0x114>
    ...
    1966:	00757713          	andi	a4,a0,7
{
    ...
    1996:	6ae53503          	ld	a0,1710(a0) # 2040 <__clone+0x11c>
    ...
    19a8:	68c8b883          	ld	a7,1676(a7) # 2030 <__clone+0x10c>
    19ac:	00000817          	auipc	a6,0x0
    19b0:	68c83803          	ld	a6,1676(a6) # 2038 <__clone+0x114>
    19b4:	431d                	li	t1,7
...
char *strcpy(char *restrict d, const char *s)
{
    ...
    1a36:	5fe63603          	ld	a2,1534(a2) # 2030 <__clone+0x10c>
    1a3a:	00000817          	auipc	a6,0x0
    1a3e:	5fe83803          	ld	a6,1534(a6) # 2038 <__clone+0x114>
...
char *strncpy(char *restrict d, const char *s, size_t n)
{
    ...
    1c18:	41c8b883          	ld	a7,1052(a7) # 2030 <__clone+0x10c>
    1c1c:	00000817          	auipc	a6,0x0
    1c20:	41c83803          	ld	a6,1052(a6) # 2038 <__clone+0x114>
    1c24:	431d                	li	t1,7
...
0000000000001df4 <munmap>:
    register long a7 __asm__("a7") = n;
    1df4:	0d700893          	li	a7,215
    __asm_syscall("r"(a7), "0"(a0), "r"(a1))
    1df8:	00000073          	ecall
...
0000000000001e14 <spawn>:
    register long a7 __asm__("a7") = n;
    1e14:	19000893          	li	a7,400
    __asm_syscall("r"(a7), "0"(a0))
    1e18:	00000073          	ecall
...
0000000000001e20 <mailread>:
    register long a7 __asm__("a7") = n;
    1e20:	19100893          	li	a7,401
    __asm_syscall("r"(a7), "0"(a0), "r"(a1))
    1e24:	00000073          	ecall
...
0000000000001e2c <mailwrite>:
    register long a7 __asm__("a7") = n;
    1e2c:	19200893          	li	a7,402
    __asm_syscall("r"(a7), "0"(a0), "r"(a1), "r"(a2))
    1e30:	00000073          	ecall
...
0000000000001e44 <sys_linkat>:
    register long a4 __asm__("a4") = e;
    1e44:	1702                	slli	a4,a4,0x20
    register long a7 __asm__("a7") = n;
    1e46:	02500893          	li	a7,37
    register long a4 __asm__("a4") = e;
    1e4a:	9301                	srli	a4,a4,0x20
    __asm_syscall("r"(a7), "0"(a0), "r"(a1), "r"(a2), "r"(a3), "r"(a4))
    1e4c:	00000073          	ecall
...
0000000000001e80 <unlink>:

int unlink(char *path)
{
    1e80:	85aa                	mv	a1,a0
    register long a7 __asm__("a7") = n;
    1e82:	02300893          	li	a7,35
    register long a0 __asm__("a0") = a;
...
0000000000001e94 <uname>:
    register long a7 __asm__("a7") = n;
    1e94:	0a000893          	li	a7,160
    __asm_syscall("r"(a7), "0"(a0))
    1e98:	00000073          	ecall
...
0000000000001ea0 <brk>:
    register long a7 __asm__("a7") = n;
    1ea0:	0d600893          	li	a7,214
    __asm_syscall("r"(a7), "0"(a0))
    1ea4:	00000073          	ecall
...
0000000000001eb4 <chdir>:
    register long a7 __asm__("a7") = n;
    1eb4:	03100893          	li	a7,49
    __asm_syscall("r"(a7), "0"(a0))
    1eb8:	00000073          	ecall
...
0000000000001ec0 <mkdir>:

int mkdir(const char *path, mode_t mode){
    1ec0:	862e                	mv	a2,a1
    1ec2:	87aa                	mv	a5,a0
    register long a2 __asm__("a2") = c;
    1ec4:	1602                	slli	a2,a2,0x20
    register long a7 __asm__("a7") = n;
    1ec6:	02200893          	li	a7,34
    register long a0 __asm__("a0") = a;
    1eca:	f9c00513          	li	a0,-100
    register long a1 __asm__("a1") = b;
    1ece:	85be                	mv	a1,a5
    register long a2 __asm__("a2") = c;
    1ed0:	9201                	srli	a2,a2,0x20
    __asm_syscall("r"(a7), "0"(a0), "r"(a1), "r"(a2))
    1ed2:	00000073          	ecall
...
0000000000001eda <getdents>:
    register long a7 __asm__("a7") = n;
    1eda:	03d00893          	li	a7,61
    __asm_syscall("r"(a7), "0"(a0), "r"(a1), "r"(a2))
    1ede:	00000073          	ecall
...
0000000000001ee6 <pipe>:
    register long a7 __asm__("a7") = n;
    1ee6:	03b00893          	li	a7,59
    register long a1 __asm__("a1") = b;
    1eea:	4581                	li	a1,0
    __asm_syscall("r"(a7), "0"(a0), "r"(a1))
    1eec:	00000073          	ecall
...
0000000000001f0a <mount>:
    register long a7 __asm__("a7") = n;
    1f0a:	02800893          	li	a7,40
    __asm_syscall("r"(a7), "0"(a0), "r"(a1), "r"(a2), "r"(a3), "r"(a4))
    1f0e:	00000073          	ecall
...
0000000000001f16 <umount>:
    register long a7 __asm__("a7") = n;
    1f16:	02700893          	li	a7,39
    register long a1 __asm__("a1") = b;
    1f1a:	4581                	li	a1,0
    __asm_syscall("r"(a7), "0"(a0), "r"(a1))
    1f1c:	00000073          	ecall
...
__clone:
	...
	addi a1, a1, -16
    1f24:	15c1                	addi	a1,a1,-16
	sd a0, 0(a1)
    1f26:	e188                	sd	a0,0(a1)
	sd a3, 8(a1)
    1f28:	e594                	sd	a3,8(a1)
    ...
    1f30:	8742                	mv	a4,a6
	li a7, 220 # SYS_clone
    1f32:	0dc00893          	li	a7,220
	ecall
    1f36:	00000073          	ecall

	beqz a0, 1f
    1f3a:	c111                	beqz	a0,1f3e <__clone+0x1a>
	# Parent
	ret
    1f3c:	8082                	ret
	...
	# Child
1:      ld a1, 0(sp)
    1f3e:	6582                	ld	a1,0(sp)
	ld a0, 8(sp)
    1f40:	6522                	ld	a0,8(sp)
	jalr a1
    1f42:	9582                	jalr	a1

	# Exit
	li a7, 93 # SYS_exit
    1f44:	05d00893          	li	a7,93
	ecall
    1f48:	00000073          	ecall
