...
/home/weihuan/Documents/testsuits-for-oskernel-preliminary/riscv-syscalls-testing/user/build/riscv64/mkdir_:     file format elf64-littleriscv
...
void test_mkdir(void){
    ...
    1046:	f0650513          	addi	a0,a0,-250 # 1f48 <__clone+0x66>
    ...
    105c:	ee050513          	addi	a0,a0,-288 # 1f38 <__clone+0x56>
    ...
    106e:	f0e50513          	addi	a0,a0,-242 # 1f78 <__clone+0x96>
    ...
    1080:	f2450513          	addi	a0,a0,-220 # 1fa0 <__clone+0xbe>
    ...
    109c:	e9050513          	addi	a0,a0,-368 # 1f28 <__clone+0x46>
}
    ...
    10a8:	eec50513          	addi	a0,a0,-276 # 1f90 <__clone+0xae>
    10ac:	2b8000ef          	jal	ra,1364 <printf>
    10b0:	b7f1                	j	107c <test_mkdir+0x78>
    assert(rt != -1);
    10b2:	00001517          	auipc	a0,0x1
    10b6:	ea650513          	addi	a0,a0,-346 # 1f58 <__clone+0x76>
    ...
    136c:	18bc                	addi	a5,sp,120
{
    ...
    1396:	c1eb0b13          	addi	s6,s6,-994 # 1fb0 <__clone+0xce>
    buf[i++] = '0';
    139a:	830aca93          	xori	s5,s5,-2000
        buf[i++] = digits[x >> (sizeof(uint64) * 8 - 4)];
    139e:	00001997          	auipc	s3,0x1
    13a2:	c4298993          	addi	s3,s3,-958 # 1fe0 <digits>
        if (!*s)
...
size_t strlen(const char *s)
{
    ...
    18ec:	6d05b583          	ld	a1,1744(a1) # 1fb8 <__clone+0xd6>
    18f0:	00000617          	auipc	a2,0x0
    18f4:	6d063603          	ld	a2,1744(a2) # 1fc0 <__clone+0xde>
    ...
    1924:	00757713          	andi	a4,a0,7
{
    ...
    1954:	67853503          	ld	a0,1656(a0) # 1fc8 <__clone+0xe6>
    ...
    1966:	6568b883          	ld	a7,1622(a7) # 1fb8 <__clone+0xd6>
    196a:	00000817          	auipc	a6,0x0
    196e:	65683803          	ld	a6,1622(a6) # 1fc0 <__clone+0xde>
    1972:	431d                	li	t1,7
...
char *strcpy(char *restrict d, const char *s)
{
    ...
    19f4:	5c863603          	ld	a2,1480(a2) # 1fb8 <__clone+0xd6>
    19f8:	00000817          	auipc	a6,0x0
    19fc:	5c883803          	ld	a6,1480(a6) # 1fc0 <__clone+0xde>
...
char *strncpy(char *restrict d, const char *s, size_t n)
{
    ...
    1bd6:	3e68b883          	ld	a7,998(a7) # 1fb8 <__clone+0xd6>
    1bda:	00000817          	auipc	a6,0x0
    1bde:	3e683803          	ld	a6,998(a6) # 1fc0 <__clone+0xde>
    1be2:	431d                	li	t1,7
