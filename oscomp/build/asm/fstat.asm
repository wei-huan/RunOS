...
/home/weihuan/Documents/testsuits-for-oskernel-preliminary/riscv-syscalls-testing/user/build/riscv64/fstat:     file format elf64-littleriscv
...
void test_fstat() {
    ...
    107e:	ef650513          	addi	a0,a0,-266 # 1f70 <__clone+0x90>
    ...
    108c:	f4850513          	addi	a0,a0,-184 # 1fd0 <__clone+0xf0>
    ...
    10a8:	e7c50513          	addi	a0,a0,-388 # 1f20 <__clone+0x40>
}
    ...
    10b4:	ea050513          	addi	a0,a0,-352 # 1f50 <__clone+0x70>
    ...
    136a:	18bc                	addi	a5,sp,120
{
    ...
    1394:	c50b0b13          	addi	s6,s6,-944 # 1fe0 <__clone+0x100>
    buf[i++] = '0';
...
size_t strlen(const char *s)
{
    ...
    18ea:	7025b583          	ld	a1,1794(a1) # 1fe8 <__clone+0x108>
    18ee:	00000617          	auipc	a2,0x0
    18f2:	70263603          	ld	a2,1794(a2) # 1ff0 <__clone+0x110>
    ...
    1922:	00757713          	andi	a4,a0,7
{
    ...
    1952:	6aa53503          	ld	a0,1706(a0) # 1ff8 <__clone+0x118>
    ...
    1964:	6888b883          	ld	a7,1672(a7) # 1fe8 <__clone+0x108>
    1968:	00000817          	auipc	a6,0x0
    196c:	68883803          	ld	a6,1672(a6) # 1ff0 <__clone+0x110>
    1970:	431d                	li	t1,7
...
char *strcpy(char *restrict d, const char *s)
{
    ...
    19f2:	5fa63603          	ld	a2,1530(a2) # 1fe8 <__clone+0x108>
    19f6:	00000817          	auipc	a6,0x0
    19fa:	5fa83803          	ld	a6,1530(a6) # 1ff0 <__clone+0x110>
...
char *strncpy(char *restrict d, const char *s, size_t n)
{
    ...
    1bd4:	4188b883          	ld	a7,1048(a7) # 1fe8 <__clone+0x108>
    1bd8:	00000817          	auipc	a6,0x0
    1bdc:	41883803          	ld	a6,1048(a6) # 1ff0 <__clone+0x110>
    1be0:	431d                	li	t1,7
