...
void test_sleep() {
    ...
    100a:	f1250513          	addi	a0,a0,-238 # 1f18 <__clone+0x28>
void test_sleep() {
    ...
    1028:	f0c50513          	addi	a0,a0,-244 # 1f30 <__clone+0x40>
    102c:	324000ef          	jal	ra,1350 <puts>

	int time1 = get_time();
    1030:	515000ef          	jal	ra,1d44 <get_time>
    1034:	0005049b          	sext.w	s1,a0
	assert(time1 >= 0);
    1038:	0804c463          	bltz	s1,10c0 <test_sleep+0xbc>
	int ret = sleep(1);
    103c:	4505                	li	a0,1
    103e:	54d000ef          	jal	ra,1d8a <sleep>
	assert(ret == 0);
    1042:	ed21                	bnez	a0,109a <test_sleep+0x96>
	int time2 = get_time();
    1044:	501000ef          	jal	ra,1d44 <get_time>
    ...
    105a:	f0a50513          	addi	a0,a0,-246 # 1f60 <__clone+0x70>
    ...
    1066:	f1e50513          	addi	a0,a0,-226 # 1f80 <__clone+0x90>
    ...
    1084:	eb050513          	addi	a0,a0,-336 # 1f30 <__clone+0x40>
}
    ...
    137a:	18bc                	addi	a5,sp,120
{
    ...
    13a4:	bf0b0b13          	addi	s6,s6,-1040 # 1f90 <__clone+0xa0>
    buf[i++] = '0';
...
size_t strlen(const char *s)
{
    ...
    18fa:	6a25b583          	ld	a1,1698(a1) # 1f98 <__clone+0xa8>
    18fe:	00000617          	auipc	a2,0x0
    1902:	6a263603          	ld	a2,1698(a2) # 1fa0 <__clone+0xb0>
    ...
    1932:	00757713          	andi	a4,a0,7
{
    ...
    1962:	64a53503          	ld	a0,1610(a0) # 1fa8 <__clone+0xb8>
    ...
    1974:	6288b883          	ld	a7,1576(a7) # 1f98 <__clone+0xa8>
    1978:	00000817          	auipc	a6,0x0
    197c:	62883803          	ld	a6,1576(a6) # 1fa0 <__clone+0xb0>
    1980:	431d                	li	t1,7
...
char *strcpy(char *restrict d, const char *s)
{
    ...
    1a02:	59a63603          	ld	a2,1434(a2) # 1f98 <__clone+0xa8>
    1a06:	00000817          	auipc	a6,0x0
    1a0a:	59a83803          	ld	a6,1434(a6) # 1fa0 <__clone+0xb0>
...
char *strncpy(char *restrict d, const char *s, size_t n)
{
    ...
    1be4:	3b88b883          	ld	a7,952(a7) # 1f98 <__clone+0xa8>
    1be8:	00000817          	auipc	a6,0x0
    1bec:	3b883803          	ld	a6,952(a6) # 1fa0 <__clone+0xb0>
    1bf0:	431d                	li	t1,7
...
0000000000001e10 <sys_linkat>:
    register long a4 __asm__("a4") = e;
    1e10:	1702                	slli	a4,a4,0x20
    register long a7 __asm__("a7") = n;
    1e12:	02500893          	li	a7,37
    register long a4 __asm__("a4") = e;
    1e16:	9301                	srli	a4,a4,0x20
    __asm_syscall("r"(a7), "0"(a0), "r"(a1), "r"(a2), "r"(a3), "r"(a4))
    1e18:	00000073          	ecall
...
0000000000001e20 <sys_unlinkat>:
    register long a2 __asm__("a2") = c;
    1e20:	1602                	slli	a2,a2,0x20
    register long a7 __asm__("a7") = n;
    1e22:	02300893          	li	a7,35
    register long a2 __asm__("a2") = c;
    1e26:	9201                	srli	a2,a2,0x20
    __asm_syscall("r"(a7), "0"(a0), "r"(a1), "r"(a2))
    1e28:	00000073          	ecall
