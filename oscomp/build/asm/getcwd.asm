...
/home/weihuan/Documents/testsuits-for-oskernel-preliminary/riscv-syscalls-testing/user/build/riscv64/getcwd:     file format elf64-littleriscv
...
void test_getcwd(void){
   ...
   TEST_START(__func__);
    ...
    1024:	ed050513          	addi	a0,a0,-304 # 1ef0 <__clone+0x42>
   ...
   TEST_END(__func__);
    ...
    1082:	e7250513          	addi	a0,a0,-398 # 1ef0 <__clone+0x42>
    ...
    1094:	e9050513          	addi	a0,a0,-368 # 1f20 <__clone+0x72>
    ...
    134a:	18bc                	addi	a5,sp,120
{
    ...
    1374:	bd0b0b13          	addi	s6,s6,-1072 # 1f40 <__clone+0x92>
    buf[i++] = '0';
...
size_t strlen(const char *s)
{
    ...
    18b8:	6945b583          	ld	a1,1684(a1) # 1f48 <__clone+0x9a>
    18bc:	00000617          	auipc	a2,0x0
    18c0:	69463603          	ld	a2,1684(a2) # 1f50 <__clone+0xa2>
    ...
    18f0:	00757713          	andi	a4,a0,7
{
    ...
    1920:	63c53503          	ld	a0,1596(a0) # 1f58 <__clone+0xaa>
    ...
    1932:	61a8b883          	ld	a7,1562(a7) # 1f48 <__clone+0x9a>
    1936:	00000817          	auipc	a6,0x0
    193a:	61a83803          	ld	a6,1562(a6) # 1f50 <__clone+0xa2>
    193e:	431d                	li	t1,7
...
char *strcpy(char *restrict d, const char *s)
{
    ...
    19c0:	58c63603          	ld	a2,1420(a2) # 1f48 <__clone+0x9a>
    19c4:	00000817          	auipc	a6,0x0
    19c8:	58c83803          	ld	a6,1420(a6) # 1f50 <__clone+0xa2>
...
char *strncpy(char *restrict d, const char *s, size_t n)
{
    ...
    1ba2:	3aa8b883          	ld	a7,938(a7) # 1f48 <__clone+0x9a>
    1ba6:	00000817          	auipc	a6,0x0
    1baa:	3aa83803          	ld	a6,938(a6) # 1f50 <__clone+0xa2>
    1bae:	431d                	li	t1,7
