...
/home/weihuan/Documents/testsuits-for-oskernel-preliminary/riscv-syscalls-testing/user/build/riscv64/dup2:     file format elf64-littleriscv
...
void test_dup2(){
    ...
    1030:	4505                	li	a0,1
    1032:	659000ef          	jal	ra,1e8a <dup2>
	assert(fd != -1);
    1036:	57fd                	li	a5,-1
    ...
    1040:	ee450513          	addi	a0,a0,-284 # 1f20 <__clone+0x70>
    1044:	051000ef          	jal	ra,1894 <strlen>
    1048:	862a                	mv	a2,a0
    104a:	00001597          	auipc	a1,0x1
    104e:	ed658593          	addi	a1,a1,-298 # 1f20 <__clone+0x70>
    1052:	06400513          	li	a0,100
    1056:	423000ef          	jal	ra,1c78 <write>
	TEST_END(__func__);
    105a:	00001517          	auipc	a0,0x1
    105e:	ed650513          	addi	a0,a0,-298 # 1f30 <__clone+0x80>
    ...
    1078:	e7c50513          	addi	a0,a0,-388 # 1ef0 <__clone+0x40>
}
    ...
    1084:	e8050513          	addi	a0,a0,-384 # 1f00 <__clone+0x50>
    ...
    133a:	18bc                	addi	a5,sp,120
{
    ...
    1364:	be0b0b13          	addi	s6,s6,-1056 # 1f40 <__clone+0x90>
    buf[i++] = '0';
