...
/home/weihuan/Documents/testsuits-for-oskernel-preliminary/riscv-syscalls-testing/user/build/riscv64/unlink:     file format elf64-littleriscv
    ...
    100a:	f1a50513          	addi	a0,a0,-230 # 1f20 <__clone+0x2e>
{
    ...
    1026:	f1650513          	addi	a0,a0,-234 # 1f38 <__clone+0x46>
    ...
    104e:	efe50513          	addi	a0,a0,-258 # 1f48 <__clone+0x56>
    1052:	5fd000ef          	jal	ra,1e4e <unlink>
    assert(ret == 0);
    1056:	ed39                	bnez	a0,10b4 <test_unlink+0xb0>
    fd = open(fname, O_RDONLY);
    1058:	4581                	li	a1,0
    105a:	00001517          	auipc	a0,0x1
    105e:	eee50513          	addi	a0,a0,-274 # 1f48 <__clone+0x56>
    ...
    1070:	f2450513          	addi	a0,a0,-220 # 1f90 <__clone+0x9e>
    ...
    1082:	f2a50513          	addi	a0,a0,-214 # 1fa8 <__clone+0xb6>
    ...
    109e:	e9e50513          	addi	a0,a0,-354 # 1f38 <__clone+0x46>
}
    ...
    137c:	18bc                	addi	a5,sp,120
{
    ...
    13a6:	c16b0b13          	addi	s6,s6,-1002 # 1fb8 <__clone+0xc6>
    buf[i++] = '0';
    13aa:	830aca93          	xori	s5,s5,-2000
        buf[i++] = digits[x >> (sizeof(uint64) * 8 - 4)];
    13ae:	00001997          	auipc	s3,0x1
    13b2:	c3a98993          	addi	s3,s3,-966 # 1fe8 <digits>
        if (!*s)
...
size_t strlen(const char *s)
{
    ...
    18fc:	6c85b583          	ld	a1,1736(a1) # 1fc0 <__clone+0xce>
    1900:	00000617          	auipc	a2,0x0
    1904:	6c863603          	ld	a2,1736(a2) # 1fc8 <__clone+0xd6>
    ...
    1934:	00757713          	andi	a4,a0,7
{
    ...
    1964:	67053503          	ld	a0,1648(a0) # 1fd0 <__clone+0xde>
    ...
    1976:	64e8b883          	ld	a7,1614(a7) # 1fc0 <__clone+0xce>
    197a:	00000817          	auipc	a6,0x0
    197e:	64e83803          	ld	a6,1614(a6) # 1fc8 <__clone+0xd6>
    1982:	431d                	li	t1,7
...
char *strcpy(char *restrict d, const char *s)
{
    ...
    1a04:	5c063603          	ld	a2,1472(a2) # 1fc0 <__clone+0xce>
    1a08:	00000817          	auipc	a6,0x0
    1a0c:	5c083803          	ld	a6,1472(a6) # 1fc8 <__clone+0xd6>
...
char *strncpy(char *restrict d, const char *s, size_t n)
{
    ...
    1be6:	3de8b883          	ld	a7,990(a7) # 1fc0 <__clone+0xce>
    1bea:	00000817          	auipc	a6,0x0
    1bee:	3de83803          	ld	a6,990(a6) # 1fc8 <__clone+0xd6>
    1bf2:	431d                	li	t1,7
