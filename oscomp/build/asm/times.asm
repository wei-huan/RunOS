...
/home/weihuan/Documents/testsuits-for-oskernel-preliminary/riscv-syscalls-testing/user/build/riscv64/times:     file format elf64-littleriscv
...
void test_times() {
    ...
    1034:	4c3000ef          	jal	ra,1cf6 <times>
	assert(test_ret >= 0);
    ...
    1050:	ed450513          	addi	a0,a0,-300 # 1f20 <__clone+0x72>
    ...
    105c:	f1850513          	addi	a0,a0,-232 # 1f70 <__clone+0xc2>
    ...
    1076:	e7e50513          	addi	a0,a0,-386 # 1ef0 <__clone+0x42>
}
    ...
    1082:	e8250513          	addi	a0,a0,-382 # 1f00 <__clone+0x52>
    ...
    1338:	18bc                	addi	a5,sp,120
{
    ...
    1362:	c22b0b13          	addi	s6,s6,-990 # 1f80 <__clone+0xd2>
    buf[i++] = '0';
...
size_t strlen(const char *s)
{
    ...
    18b8:	6d45b583          	ld	a1,1748(a1) # 1f88 <__clone+0xda>
    18bc:	00000617          	auipc	a2,0x0
    18c0:	6d463603          	ld	a2,1748(a2) # 1f90 <__clone+0xe2>
    ...
    18f0:	00757713          	andi	a4,a0,7
{
    ...
    1920:	67c53503          	ld	a0,1660(a0) # 1f98 <__clone+0xea>
    ...
    1932:	65a8b883          	ld	a7,1626(a7) # 1f88 <__clone+0xda>
    1936:	00000817          	auipc	a6,0x0
    193a:	65a83803          	ld	a6,1626(a6) # 1f90 <__clone+0xe2>
    193e:	431d                	li	t1,7
...
char *strcpy(char *restrict d, const char *s)
{
    ...
    19c0:	5cc63603          	ld	a2,1484(a2) # 1f88 <__clone+0xda>
    19c4:	00000817          	auipc	a6,0x0
    19c8:	5cc83803          	ld	a6,1484(a6) # 1f90 <__clone+0xe2>
...
char *strncpy(char *restrict d, const char *s, size_t n)
{
    ...
    1ba2:	3ea8b883          	ld	a7,1002(a7) # 1f88 <__clone+0xda>
    1ba6:	00000817          	auipc	a6,0x0
    1baa:	3ea83803          	ld	a6,1002(a6) # 1f90 <__clone+0xe2>
    1bae:	431d                	li	t1,7
