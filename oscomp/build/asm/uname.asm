...
/home/weihuan/Documents/testsuits-for-oskernel-preliminary/riscv-syscalls-testing/user/build/riscv64/uname:     file format elf64-littleriscv
...
void test_uname() {
    ...
    1070:	ed450513          	addi	a0,a0,-300 # 1f40 <__clone+0x72>
    ...
    107c:	ee850513          	addi	a0,a0,-280 # 1f60 <__clone+0x92>
    ...
    1096:	e7e50513          	addi	a0,a0,-386 # 1f10 <__clone+0x42>
}
    ...
    10a2:	e8250513          	addi	a0,a0,-382 # 1f20 <__clone+0x52>
    ...
    1358:	18bc                	addi	a5,sp,120
{
    ...
    1382:	bf2b0b13          	addi	s6,s6,-1038 # 1f70 <__clone+0xa2>
    buf[i++] = '0';
...
size_t strlen(const char *s)
{
    ...
    18d8:	6a45b583          	ld	a1,1700(a1) # 1f78 <__clone+0xaa>
    18dc:	00000617          	auipc	a2,0x0
    18e0:	6a463603          	ld	a2,1700(a2) # 1f80 <__clone+0xb2>
    ...
    1910:	00757713          	andi	a4,a0,7
{
    ...
    1940:	64c53503          	ld	a0,1612(a0) # 1f88 <__clone+0xba>
    ...
    1952:	62a8b883          	ld	a7,1578(a7) # 1f78 <__clone+0xaa>
    1956:	00000817          	auipc	a6,0x0
    195a:	62a83803          	ld	a6,1578(a6) # 1f80 <__clone+0xb2>
    195e:	431d                	li	t1,7
...
char *strcpy(char *restrict d, const char *s)
{
    ...
    19e0:	59c63603          	ld	a2,1436(a2) # 1f78 <__clone+0xaa>
    19e4:	00000817          	auipc	a6,0x0
    19e8:	59c83803          	ld	a6,1436(a6) # 1f80 <__clone+0xb2>
...
char *strncpy(char *restrict d, const char *s, size_t n)
{
    ...
    1bc2:	3ba8b883          	ld	a7,954(a7) # 1f78 <__clone+0xaa>
    1bc6:	00000817          	auipc	a6,0x0
    1bca:	3ba83803          	ld	a6,954(a6) # 1f80 <__clone+0xb2>
    1bce:	431d                	li	t1,7
