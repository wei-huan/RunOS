...
/home/weihuan/Documents/testsuits-for-oskernel-preliminary/riscv-syscalls-testing/user/build/riscv64/chdir:     file format elf64-littleriscv
...
void test_chdir(void){
    ...
    100a:	efa50513          	addi	a0,a0,-262 # 1f00 <__clone+0x2a>
void test_chdir(void){
    ...
    1026:	ef650513          	addi	a0,a0,-266 # 1f18 <__clone+0x42>
    102a:	30c000ef          	jal	ra,1336 <puts>
    mkdir("test_chdir", 0666);
    102e:	1b600593          	li	a1,438
    1032:	00001517          	auipc	a0,0x1
    1036:	ef650513          	addi	a0,a0,-266 # 1f28 <__clone+0x52>
    103a:	639000ef          	jal	ra,1e72 <mkdir>
    int ret = chdir("test_chdir");
    103e:	00001517          	auipc	a0,0x1
    1042:	eea50513          	addi	a0,a0,-278 # 1f28 <__clone+0x52>
    1046:	621000ef          	jal	ra,1e66 <chdir>
    104a:	842a                	mv	s0,a0
    printf("chdir ret: %d\n", ret);
    104c:	85aa                	mv	a1,a0
    104e:	00001517          	auipc	a0,0x1
    1052:	eea50513          	addi	a0,a0,-278 # 1f38 <__clone+0x62>
    ...
    109e:	e7e50513          	addi	a0,a0,-386 # 1f18 <__clone+0x42>
}
    ...
    10aa:	ea250513          	addi	a0,a0,-350 # 1f48 <__clone+0x72>
    ...
    1360:	18bc                	addi	a5,sp,120
{
    ...
    138a:	c12b0b13          	addi	s6,s6,-1006 # 1f98 <__clone+0xc2>
    buf[i++] = '0';
...
size_t strlen(const char *s)
{
    ...
    18e0:	6c45b583          	ld	a1,1732(a1) # 1fa0 <__clone+0xca>
    18e4:	00000617          	auipc	a2,0x0
    18e8:	6c463603          	ld	a2,1732(a2) # 1fa8 <__clone+0xd2>
    ...
    1918:	00757713          	andi	a4,a0,7
{
    ...
    1948:	66c53503          	ld	a0,1644(a0) # 1fb0 <__clone+0xda>
    ...
    195a:	64a8b883          	ld	a7,1610(a7) # 1fa0 <__clone+0xca>
    195e:	00000817          	auipc	a6,0x0
    1962:	64a83803          	ld	a6,1610(a6) # 1fa8 <__clone+0xd2>
    1966:	431d                	li	t1,7
...
char *strcpy(char *restrict d, const char *s)
{
    ...
    19e8:	5bc63603          	ld	a2,1468(a2) # 1fa0 <__clone+0xca>
    19ec:	00000817          	auipc	a6,0x0
    19f0:	5bc83803          	ld	a6,1468(a6) # 1fa8 <__clone+0xd2>
...
char *strncpy(char *restrict d, const char *s, size_t n)
{
    ...
    1bca:	3da8b883          	ld	a7,986(a7) # 1fa0 <__clone+0xca>
    1bce:	00000817          	auipc	a6,0x0
    1bd2:	3da83803          	ld	a6,986(a6) # 1fa8 <__clone+0xd2>
    1bd6:	431d                	li	t1,7
...
0000000000001df6 <sys_linkat>:
    register long a4 __asm__("a4") = e;
    1df6:	1702                	slli	a4,a4,0x20
    register long a7 __asm__("a7") = n;
    1df8:	02500893          	li	a7,37
    register long a4 __asm__("a4") = e;
    1dfc:	9301                	srli	a4,a4,0x20
    __asm_syscall("r"(a7), "0"(a0), "r"(a1), "r"(a2), "r"(a3), "r"(a4))
    1dfe:	00000073          	ecall
