...
/home/weihuan/Documents/testsuits-for-oskernel-preliminary/riscv-syscalls-testing/user/build/riscv64/brk:     file format elf64-littleriscv
...
void test_brk(){
    ...
    102a:	ed250513          	addi	a0,a0,-302 # 1ef8 <__clone+0x42>
    102e:	2fa000ef          	jal	ra,1328 <puts>
    intptr_t cur_pos, alloc_pos, alloc_pos_1;

    cur_pos = brk(0);
    1032:	4501                	li	a0,0
    1034:	5ff000ef          	jal	ra,1e32 <brk>
    ...
    1040:	ecc50513          	addi	a0,a0,-308 # 1f08 <__clone+0x52>
    1044:	306000ef          	jal	ra,134a <printf>
    brk(cur_pos + 64);
    1048:	04040513          	addi	a0,s0,64
    104c:	5e7000ef          	jal	ra,1e32 <brk>
    alloc_pos = brk(0);
    1050:	4501                	li	a0,0
    1052:	5e1000ef          	jal	ra,1e32 <brk>
    ...
    105e:	ece50513          	addi	a0,a0,-306 # 1f28 <__clone+0x72>
    1062:	2e8000ef          	jal	ra,134a <printf>
    brk(alloc_pos + 64);
    1066:	04040513          	addi	a0,s0,64
    106a:	5c9000ef          	jal	ra,1e32 <brk>
    alloc_pos_1 = brk(0);
    106e:	4501                	li	a0,0
    1070:	5c3000ef          	jal	ra,1e32 <brk>
    1074:	85aa                	mv	a1,a0
    printf("Alloc again,heap pos: %d\n",alloc_pos_1);
    1076:	00001517          	auipc	a0,0x1
    107a:	ed250513          	addi	a0,a0,-302 # 1f48 <__clone+0x92>
    107e:	2cc000ef          	jal	ra,134a <printf>
    TEST_END(__func__);
    1082:	00001517          	auipc	a0,0x1
    1086:	ee650513          	addi	a0,a0,-282 # 1f68 <__clone+0xb2>
    ...
    109e:	e5e50513          	addi	a0,a0,-418 # 1ef8 <__clone+0x42>
}
    ...
    1352:	18bc                	addi	a5,sp,120
{
    ...
    137c:	c00b0b13          	addi	s6,s6,-1024 # 1f78 <__clone+0xc2>
    buf[i++] = '0';
...
size_t strlen(const char *s)
{
    ...
    18c0:	6c45b583          	ld	a1,1732(a1) # 1f80 <__clone+0xca>
    18c4:	00000617          	auipc	a2,0x0
    18c8:	6c463603          	ld	a2,1732(a2) # 1f88 <__clone+0xd2>
    ...
    18f8:	00757713          	andi	a4,a0,7
{
    ...
    1928:	66c53503          	ld	a0,1644(a0) # 1f90 <__clone+0xda>
    ...
    193a:	64a8b883          	ld	a7,1610(a7) # 1f80 <__clone+0xca>
    193e:	00000817          	auipc	a6,0x0
    1942:	64a83803          	ld	a6,1610(a6) # 1f88 <__clone+0xd2>
    1946:	431d                	li	t1,7
...
char *strcpy(char *restrict d, const char *s)
{
    ...
    19c8:	5bc63603          	ld	a2,1468(a2) # 1f80 <__clone+0xca>
    19cc:	00000817          	auipc	a6,0x0
    19d0:	5bc83803          	ld	a6,1468(a6) # 1f88 <__clone+0xd2>
...
char *strncpy(char *restrict d, const char *s, size_t n)
{
    ...
    1baa:	3da8b883          	ld	a7,986(a7) # 1f80 <__clone+0xca>
    1bae:	00000817          	auipc	a6,0x0
    1bb2:	3da83803          	ld	a6,986(a6) # 1f88 <__clone+0xd2>
    1bb6:	431d                	li	t1,7
