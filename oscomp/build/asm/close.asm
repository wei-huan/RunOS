...
/home/weihuan/Documents/testsuits-for-oskernel-preliminary/riscv-syscalls-testing/user/build/riscv64/close:     file format elf64-littleriscv
...
void test_close(void) {
    ...
    101a:	f9250513          	addi	a0,a0,-110 # 1fa8 <__func__.0>
    ...
    1036:	eee50513          	addi	a0,a0,-274 # 1f20 <__clone+0x54>
    ...
    1044:	ef050513          	addi	a0,a0,-272 # 1f30 <__clone+0x64>
    ...
    1054:	ee058593          	addi	a1,a1,-288 # 1f30 <__clone+0x64>
    1058:	8522                	mv	a0,s0
    ...
    106c:	ef850513          	addi	a0,a0,-264 # 1f60 <__clone+0x94>
    1070:	2de000ef          	jal	ra,134e <printf>
	
    TEST_END(__func__);
    1074:	00001517          	auipc	a0,0x1
    1078:	f0450513          	addi	a0,a0,-252 # 1f78 <__clone+0xac>
    107c:	2b0000ef          	jal	ra,132c <puts>
    1080:	00001517          	auipc	a0,0x1
    1084:	f2850513          	addi	a0,a0,-216 # 1fa8 <__func__.0>
    ...
    1094:	e8050513          	addi	a0,a0,-384 # 1f10 <__clone+0x44>
}
    ...
    10a0:	ea450513          	addi	a0,a0,-348 # 1f40 <__clone+0x74>
    ...
    10d6:	f406                	sd	ra,40(sp)
{
    ...
    10e4:	ed860613          	addi	a2,a2,-296 # 1fb8 <digits>
    buf[16] = 0;
    ...
    121a:	da260613          	addi	a2,a2,-606 # 1fb8 <digits>
    buf[16] = 0;
    ...
    1356:	18bc                	addi	a5,sp,120
{
    ...
    1380:	c0cb0b13          	addi	s6,s6,-1012 # 1f88 <__clone+0xbc>
    buf[i++] = '0';
    1384:	830aca93          	xori	s5,s5,-2000
        buf[i++] = digits[x >> (sizeof(uint64) * 8 - 4)];
    1388:	00001997          	auipc	s3,0x1
    138c:	c3098993          	addi	s3,s3,-976 # 1fb8 <digits>
        if (!*s)
...
size_t strlen(const char *s)
{
    ...
    18d6:	6be5b583          	ld	a1,1726(a1) # 1f90 <__clone+0xc4>
    18da:	00000617          	auipc	a2,0x0
    18de:	6be63603          	ld	a2,1726(a2) # 1f98 <__clone+0xcc>
    ...
    190e:	00757713          	andi	a4,a0,7
{
    ...
    193e:	66653503          	ld	a0,1638(a0) # 1fa0 <__clone+0xd4>
    ...
    1950:	6448b883          	ld	a7,1604(a7) # 1f90 <__clone+0xc4>
    1954:	00000817          	auipc	a6,0x0
    1958:	64483803          	ld	a6,1604(a6) # 1f98 <__clone+0xcc>
    195c:	431d                	li	t1,7
...
char *strcpy(char *restrict d, const char *s)
{
    ...
    19de:	5b663603          	ld	a2,1462(a2) # 1f90 <__clone+0xc4>
    19e2:	00000817          	auipc	a6,0x0
    19e6:	5b683803          	ld	a6,1462(a6) # 1f98 <__clone+0xcc>
...
char *strncpy(char *restrict d, const char *s, size_t n)
{
    ...
    1bc0:	3d48b883          	ld	a7,980(a7) # 1f90 <__clone+0xc4>
    1bc4:	00000817          	auipc	a6,0x0
    1bc8:	3d483803          	ld	a6,980(a6) # 1f98 <__clone+0xcc>
    1bcc:	431d                	li	t1,7
